...
class MainForm(Frame):
    ...
    def createWidget(self):
        ...
        self.lblMsg.pack()
        self.btnLogin=Button(self, text="Login", height="3", width="40", command = self.lblLogin_Click)
        self.btnLogin.pack()
        self.btnRegister=Button(self, text="Register", height="3", width="40", command = self.btnRegister_Click)
        self.btnRegister.pack()
        self.lblTeam=Label(self, text="Made by:", bg="slateblue4", width = "35", height = "1", font=("Calibri", 13))
        self.lblTeam.pack()
        self.lblTeam1=Label(self, text="Md Saif Ali", bg="RoyalBlue1", width = "30", height = "1", font=("Calibri", 13))
        self.lblTeam1.pack()
        self.lblTeam2=Label(self, text="Aditya Raj", bg="RoyalBlue2", width = "30", height = "1", font=("Calibri", 13))
        self.lblTeam2.pack()
        self.lblTeam3=Label(self, text="Manohar Kumar", bg="RoyalBlue3", width = "30", height = "1", font=("Calibri", 13))
        self.lblTeam3.pack()
